...
func validateAccessToken(accessToken []string) (*jwtverifier.Jwt, error) {
	...
	jwtVerifierSetup := jwtverifier.JwtVerifier{
		Issuer: "https://dev-741816.okta.com/oauth2/default",
		//ClaimsToValidate: map[string]string{"aud": "api://default", "cid": "{CLIENT_ID}"},
		ClaimsToValidate: map[string]string{"aud": "api://default", "cid": "0oa5ktjpysnCikq2e4x6"},
	}
	verifier := jwtVerifierSetup.New()
	return verifier.VerifyAccessToken(parts[1])
}
